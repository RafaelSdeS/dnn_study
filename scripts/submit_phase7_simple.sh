...
#
# Usage:
#   bash scripts/submit_phase7_simple.sh                       # Submit all 3, detection
#   bash scripts/submit_phase7_simple.sh alexnet_bottleneck alexnet_fire  # Specific models
#   TASK=segmentation bash scripts/submit_phase7_simple.sh     # Segmentation instead
