...
Usage:
    python -m scripts.phase7.backfill_gzip
    python -m scripts.phase7.backfill_gzip --root checkpoints --root outputs/pcad/phase_7_detection_segmentation
"""
...
DEFAULT_ROOTS = ["checkpoints", "outputs/pcad/phase_7_detection_segmentation"]
