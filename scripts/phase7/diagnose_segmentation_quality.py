...
Usage:
    python -m scripts.phase7.diagnose_segmentation_quality
"""
...
PHASE7_DIR = Path("outputs/pcad/phase_7_detection_segmentation")
...
def load_model(arch: str, device: torch.device) -> torch.nn.Module:
    run_dir = PHASE7_DIR / f"seg_{arch}_fp32_phase_7_segmentation"
