...
Usage:
    python -m scripts.phase7.backfill_int8_size_segmentation
    python -m scripts.phase7.backfill_int8_size_segmentation --phase7-dir outputs/pcad/phase_7_detection_segmentation
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--phase7-dir", default="outputs/pcad/phase_7_detection_segmentation")
