...
Usage:
    python -m scripts.phase7.measure_true_model_size_segmentation
"""
...
def measure(phase7_dir: Path) -> None:
    ...
    for run_dir in sorted(phase7_dir.glob("seg_*")):
        ...
        if m.group("stage") == "fp32":
            ...
            # script does at eval time -- see scripts/phase7/backfill_int8_size_segmentation.py.
...
if __name__ == "__main__":
    measure(Path("outputs/pcad/phase_7_detection_segmentation"))
