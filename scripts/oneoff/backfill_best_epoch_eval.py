...
Usage:
    python -m scripts.oneoff.backfill_best_epoch_eval
    python -m scripts.oneoff.backfill_best_epoch_eval --dry-run
"""
...
MODELS = [
    ("swin_pico_w2", "outputs/pcad/phase_8_efficient_vit/swin_pico_w2"),
    ("swin_pico_w4", "outputs/pcad/phase_8_efficient_vit/swin_pico_w4"),
    ("swin_pico_w8", "outputs/pcad/phase_8_efficient_vit/swin_pico_w8"),
    ("swin_pico_poolmixer", "outputs/pcad/phase_8_efficient_vit/swin_pico_poolmixer"),
    ("hybrid_bottleneck_swin", "outputs/pcad/phase_8_efficient_vit/hybrid_bottleneck_swin"),
    ("alexnet_fire_bypass",
