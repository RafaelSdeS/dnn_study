...
Usage:
    python -m scripts.phase6.winograd_quant_error --experiment phase_6_hardware_profiling --runtime local [--dry-run]
    python -m scripts.phase6.winograd_quant_error --experiment phase_6_hardware_profiling --runtime pcad [--dry-run]
...
def main():
    ...
    parser.add_argument("--experiment", default="phase_6_hardware_profiling", help="Experiment config file name")
