...
Usage:
    python -m scripts.phase6.phase6_eixo3_stats

Reads:
    results/phase_6_hardware_profiling/layer_summary.csv
    results/phase_6_hardware_profiling/model_summary.csv
"""
...
RESULTS_DIR = Path(__file__).resolve().parent.parent / "results" / "phase_6_hardware_profiling"
