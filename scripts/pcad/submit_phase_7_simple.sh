...
#
# Usage:
#   bash scripts/pcad/submit_phase_7_simple.sh                       # Submit all 3, detection
#   bash scripts/pcad/submit_phase_7_simple.sh alexnet_bottleneck alexnet_fire  # Specific models
#   TASK=segmentation bash scripts/pcad/submit_phase_7_simple.sh     # Segmentation instead
...
for model in "${MODELS[@]}"; do
    ...
    # previously passed as (detection, $model, phase_7_detection), which put the model name in
