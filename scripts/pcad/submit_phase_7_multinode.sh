...
#
# Usage:
#   bash scripts/pcad/submit_phase_7_multinode.sh                 # FP32 only, from-scratch backbones
#   bash scripts/pcad/submit_phase_7_multinode.sh qat             # FP32 + QAT
#   bash scripts/pcad/submit_phase_7_multinode.sh qat int8        # FP32 + QAT + INT8
#   bash scripts/pcad/submit_phase_7_multinode.sh segmentation qat int8  # same, segmentation task
#   bash scripts/pcad/submit_phase_7_multinode.sh pretrained      # same, but init backbones from
