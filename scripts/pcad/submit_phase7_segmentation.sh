...
#
# Usage:
#   bash scripts/pcad/submit_phase7_segmentation.sh                              # Submit all 3
#   bash scripts/pcad/submit_phase7_segmentation.sh alexnet_bottleneck alexnet_fire  # Submit specific models
