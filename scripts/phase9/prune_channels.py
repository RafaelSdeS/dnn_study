...
Mechanics pass (docs/plans/PHASE9_PLAN.md Task 2): prunes each `_AlexBottleneck` block's
...
def _finetune_and_quantize(
    ...
    flow — closes the gap docs/plans/PHASE9_PLAN.md leaves open (H2's fine-tuning loop, future work).
