...
def aggregate(experiment: str, runtime: str) -> Path:
    ...
    # curated cross-model roll-up belongs in the tracked results/ tree, not in raw outputs/
    output_path = Path("results") / experiment / f"{experiment}_final_comparison.csv"
