...
Usage:
    python -m scripts.phase7_tools.backfill_int8_size_segmentation
    python -m scripts.phase7_tools.backfill_int8_size_segmentation --phase7-dir outputs/detection_segmentation/phase7
"""
