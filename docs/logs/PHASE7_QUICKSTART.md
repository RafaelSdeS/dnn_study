...
config (mAP 0.4–7.1%, invalid — not just low) — root-caused and fixed in `docs/logs/PHASE7_LOG.md`
...
`docs/plans/BEST_MODELS.md`'s Phase 7 section and `docs/logs/PHASE7_LOG.md`'s Implementation Status for the
...
- **Blueprint:** `docs/plans/PHASE7_PLAN.md` (detailed research hypotheses H1-H4)
- **Log:** `docs/logs/PHASE7_LOG.md` (per-stage decisions)
