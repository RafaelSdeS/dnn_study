...
notebooks/                # Organized by phase + purpose
  ...
  phase_8_efficient_vit_hybrid_attention_training/    # vit_qat_phase8 (vit_tiny/deit_tiny FP32→distill/QAT→INT8 —
